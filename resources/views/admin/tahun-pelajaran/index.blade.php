                ...
                <tbody>                                 
                    @foreach($tahun_pelajarans as $tahun_pelajaran)
                        <tr>
                            ...
                            <td>{{ $tahun_pelajaran->nm_jenis }}</td>
                            <td>Rp {{ number_format($tahun_pelajaran->biaya, 0, '','.')}}</td>
                            <td>{{ $tahun_pelajaran->kelas }}</td>
                            <td>{{ $tahun_pelajaran->ket }}</td>
                            <td>
                                <a href="{{ route('admin.jenis-bayar.edit', ['tahun_pelajaran' => $tahun_pelajaran->id]) }}" class="btn btn-primary m-1"><i class="fas fa-pencil-alt"></i></a>
                                <form action="{{ route('admin.jenis-bayar.delete', ['tahun_pelajaran' => $tahun_pelajaran->id]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
